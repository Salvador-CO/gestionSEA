...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">Resumen general del sistema SIGAE-SEA</small>
        </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #5F666B !important;">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        {{-- <div class="fs-2 fw-bold lh-1" style="color:#5F666B;">{{ $totalCorreosPendientes }}
                    </div> --}}
...
<div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 70vh;">
    <div class="card border-0 shadow-sm text-center" style="max-width: 520px; width: 100%;">
        <div class="card-body py-5 px-4">
            ...
            <h3 class="fw-bold mb-1" style="color:#212529;">SIGAE-SEA</h3>
            <p class="text-muted small mb-4">Sistema de Gestion Academica Escolar Asesores y Alumnos (SEA)</p>
        ...
        if (chartEstadoDom) {
            ...
            if (total > 0) {
                ...
                new ApexCharts(chartEstadoDom, {
                    ...
                    dataLabels: {
                        enabled: true,
                        formatter: (v, o) => o.w.config.series[o.seriesIndex] + ' (' + Math.round(v) + '%)'
                    },
                    plotOptions: {
                        pie: {
                            expandOnClick: false
